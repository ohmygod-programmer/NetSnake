...
public class SnakeCreateGamePane extends JPanel {
    ...
    public SnakeCreateGamePane() {
        ...
        widthBoxModel = new SpinnerNumberModel(
                SnakeGameParameters.MIN_WIDTH, SnakeGameParameters.MIN_WIDTH, SnakeGameParameters.MAX_WIDTH, 1);
        JSpinner widthBox = new JSpinner(widthBoxModel);

        // Create height box
        JLabel heightLabel = new JLabel(" x Field height: ");
        heightBoxModel = new SpinnerNumberModel(
                SnakeGameParameters.MIN_HEIGHT, SnakeGameParameters.MIN_HEIGHT, SnakeGameParameters.MAX_HEIGHT, 1);
